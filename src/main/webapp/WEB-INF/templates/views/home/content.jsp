	...
	<div class="carousel-inner" role="listbox">
		<div class="item">
			...
			<img class="first-slide"
				src="  <c:url value="/resources/images/1.jpg"/>" alt="First slide">

		</div>
		<div class="item active">

			<img class="second-slide"
				src="<c:url value="/resources/images/2.jpg"/>" alt="Second slide">
			<div class="container">
		...
		<div class="item">
			...
			<img class="third-slide"
				src=" <c:url value="/resources/images/3.jpg"/>" alt="Third slide">
			<div class="container">
				<div class="carousel-caption"></div>
			</div>
		</div>
