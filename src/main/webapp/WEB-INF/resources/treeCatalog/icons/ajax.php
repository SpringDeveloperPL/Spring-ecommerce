...
//ID-specifies a unique branch identifier
//PARENT-DEFINED IN THE WHO TREE IS A PARENT
// *menuMode* - the command menu: 1 - right-click menu,
//2 - icon menu, 3 - both (integer, default is 1)
